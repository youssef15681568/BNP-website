...
export default function HealthNews(){
	...
	useEffect(()=>{
		fetch(`https://newsapi.org/v2/top-headlines?category=health&country=us&apiKey=${API_KEY}`)
			.then((res)=>{
	...
	return(
		<>
			<h1 className = "text-white shadow-xl bg-primary p-2 flex justify-center items-center h-10 font-bold mt-5">Health News</h1>
