...
{/*Search button*/}						<path d="M 21 3 C 11.601563 3 4 10.601563 4 20 C 4 29.398438 11.601563 37 21 37 C 24.355469 37 27.460938 36.015625 30.09375 34.34375 L 42.375 46.625 L 46.625 42.375 L 34.5 30.28125 C 36.679688 27.421875 38 23.878906 38 20 C 38 10.601563 30.398438 3 21 3 Z M 21 7 C 28.199219 7 34 12.800781 34 20 C 34 27.199219 28.199219 33 21 33 C 13.800781 33 8 27.199219 8 20 C 8 12.800781 13.800781 7 21 7 Z"></path>
			...
			<div className = {`fixed z-100  transition-all duration-500 ${showNavbar ? "top-[56px] backdrop-blur" : "top-[56px] pointer-events-none "}`}>
				<ul className = "flex justify-between 
					...
					<li className = {`relative left-0 nav-style transition-all duration-500 ${showNavbar ? "left-0" : "scale-x-0 opacity-0"}`}><Link to = "*">Home</Link></li>
					<li className = {`relative left-0 nav-style transition-all duration-300 ${showNavbar ? "right-0" : "scale-x-0 opacity-0"}`}><Link to = "/business">Business</Link></li>
					<li className = {`relative left-0 nav-style transition-all duration-500 ${showNavbar ? "left-0" : "scale-x-0 opacity-0"}`}><Link to = "/health">Health</Link></li>
					<li className = {`relative left-0 nav-style transition-all duration-300 ${showNavbar ? "right-0" : "scale-x-0 opacity-0"}`}><Link to = "/science">Science</Link></li>
					<li className = {`relative left-0 nav-style transition-all duration-500 ${showNavbar ? "left-0" : "scale-x-0 opacity-0"}`}><Link to = "/sports">Sports</Link></li>
					<li className = {`relative left-0 nav-style transition-all duration-300 ${showNavbar ? "right-0" : "scale-x-0 opacity-0"}`}><Link to = "/entertainment">Entertainment</Link></li>
					<li className = {`relative left-0 nav-style transition-all duration-500 ${showNavbar ? "left-0" : "scale-x-0 opacity-0"}`}><Link to = "/technology">Technology</Link></li>
				</ul>
	...
	{/*Search button*/}			<path d="M 21 3 C 11.601563 3 4 10.601563 4 20 C 4 29.398438 11.601563 37 21 37 C 24.355469 37 27.460938 36.015625 30.09375 34.34375 L 42.375 46.625 L 46.625 42.375 L 34.5 30.28125 C 36.679688 27.421875 38 23.878906 38 20 C 38 10.601563 30.398438 3 21 3 Z M 21 7 C 28.199219 7 34 12.800781 34 20 C 34 27.199219 28.199219 33 21 33 C 13.800781 33 8 27.199219 8 20 C 8 12.800781 13.800781 7 21 7 Z"></path>
		...
		<footer className = "bg-primary h-85 grid grid-cols-3 
								max-sm:grid-cols-1 max-sm:grid-rows-3 p-4">
			...
			<div className = "flex flex-col items-center w-full max-sm:justify-center">
				<h3 className = "text-secondary text-xl select-none font-bold ">Categories</h3>
				<ul className = "w-[142px] flex flex-col items-start max-sm:items-center">
					<li className = "footer-categories-list mb-0" onClick = {scrollToTop}><Link to = "/general" spy={true} smooth={true} duration={500} delay={100}>General</Link></li>
					<li className = "footer-categories-list mb-0" onClick = {scrollToTop}><Link to = "/business" spy={true} smooth={true} duration={500} delay={100}>Business</Link></li>
					<li className = "footer-categories-list mb-0" onClick = {scrollToTop}><Link to = "/health" spy={true} smooth={true} duration={500} delay={100}>Health</Link></li>
					<li className = "footer-categories-list mb-0" onClick = {scrollToTop}><Link to = "/science" spy={true} smooth={true} duration={500} delay={100}>Science</Link></li>
					<li className = "footer-categories-list mb-0" onClick = {scrollToTop}><Link to = "/sports" spy={true} smooth={true} duration={500} delay={100}>Sports</Link></li>
					<li className = "footer-categories-list mb-0" onClick = {scrollToTop}><Link to = "/entertainment" spy={true} smooth={true} duration={500} delay={100}>Entertainment</Link></li>
					<li className = "footer-categories-list mb-0" onClick = {scrollToTop}><Link to = "/technology" spy={true} smooth={true} duration={500} delay={100}>Technology</Link></li>
				</ul>
			</div>
			<div className = "flex flex-col items-center justify-center ">
				<h5 className = "text-white font-xl select-none mb-6">Follow us on</h5>
				<ul className = "flex justify-center items-center max-sm:flex-col">
					<li className = "flex justify-center items-center w-20 h-20 p-0 bg-secondary hover:bg-transparent hover:border-4 hover:border-secondary hover:border-solid border-transparent border-4 cursor-pointer transition-all hover:w-24 duration-300
										bg-secondary max-sm:pointer-events-auto max-sm:duration-100 max-sm:active:bg-transparent max-sm:border-y-transparent max-sm:border-y-4 max-sm:active:border-y-solid max-sm:active:border-y-secondary transition-all max-sm:active:w-screen " >
