			...
			<div className = "bg-primary flex flex-col items-center justify-center w-[400px] h-[570px] ">
				<div className = "flex flex-col items-center mb-5">
					...
					<span className = 'flex items-center'>
						<hr className = "fill-green-500 w-20"/>
							<h4 className = "font-light text-xl text-white p hover:text-white select-none px-3">Sign-up</h4>
						<hr className = "fill-green-500 w-20"/>
					</span>
				</div>
				<div className = "flex flex-col items-start">
					...
					<div className = "w-full flex justify-center items-center flex-col">
						<p className = "my-2 text-white">Already have an account? <span className = "text-white hover:text-secondary hover:underline cursor-pointer transition-colors duration-200">sign-in</span>.</p>
						<span className = 'flex items-center'>
